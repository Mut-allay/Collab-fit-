...
const firebaseConfig = {
  apiKey: "AIzaSyBAZn6y3A-T73ZB2JRGhnny7j0hFe96ag8",
  authDomain: "fitspark-production.firebaseapp.com",
  projectId: "fitspark-production",
  storageBucket: "fitspark-production.firebasestorage.app",
...
async function seedFirestore() {
  console.log(
    "🔥 Starting Firestore seeding process for PRODUCTION (Client-side)...\n"
  );
